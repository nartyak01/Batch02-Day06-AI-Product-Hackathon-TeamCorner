...
- suggest_specialty: gọi medical routing tool để gợi ý chuyên khoa từ symptom_summary.
- get_available_slots: gọi slot tool để lấy lịch trống theo specialty_id và facility_id.
